        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/instance/list">List Instance</a>
                    </li>
                    <li>
                        <a href="admin/instance/add">Add Instance</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                <a href="#"><i class="fa fa-cube fa-fw"></i> Host<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/host/list">List Host</a>
                    </li>
                    <li>
                        <a href="admin/host/add">Add Host</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="admin/project/list">List Project</a>
                    </li>
                    <li>
